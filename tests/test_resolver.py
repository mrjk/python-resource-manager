...
class TestEdgeLink:
    ...
    def test_edge_link_initialization(self):
        ...
        # Create links
        requirement = ResourceRequireLink({"kind": "test.dependency"}, parent=req_resource)
        provider = ResourceProviderLink({"kind": "test.dependency"}, parent=prov_resource)
    ...
    def test_edge_link_rule_property(self):
        ...
        requirement1 = ResourceRequireLink({"kind": "test.dep", "instance": "inst1", "mod": "!"}, parent=req_resource)
        provider1 = ResourceProviderLink({"kind": "test.dep", "instance": "inst1"}, parent=prov_resource)
...
@pytest.mark.parametrize("resources,feature_names,expected_order", [
